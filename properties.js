    ...
    $.Redactor.prototype.properties = function()
    {
        return {
            ...
            setup: function()
            {
                ...
                this.opts.properties.show = true;
            },
            init: function()
            {
                ...
                var button = this.button.add('properties', 'Properties');
            ...
            show: function()
            {
                ...
                var button = this.modal.createActionButton().text('Save');
            ...
            setEvents: function()
            {
                this.core.getElement().on('click.callback.redactor', this.properties.showOnClick);
                $(document).on('mousedown.redactor-properties', $.proxy(this.properties.hideOnBlur, this));

                this.core.getElement().on('destroy.callback.redactor', $.proxy(function()
                {
